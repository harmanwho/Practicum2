...
processProfessions <- function(nconst, primaryName, birthYear, deathYear, primaryProfession, knownForTitles) {
    splitProfessions <- str_split(primaryProfession, ",")
    print(splitProfessions)
    professionsToEnter <- data.frame("primaryProfession"=splitProfessions) 
...
#addActor("n52320301", "Lady Gaga", 1980, 2020, "actor,singer,dancer", "t500005,t60500")
```
